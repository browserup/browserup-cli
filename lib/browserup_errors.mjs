...
export class ClusterOlderThanCLI extends Error {
    constructor(clusterServicesVersion) {
        super(`Cluster services: "${clusterServicesVersion}" vs built-in services: "${SERVICES_VERSION}"`);
    }
}
...
export const ErrorType = {
    ...
    INVALID_WORKING_DIR: "Invalid working directory - contains browserup node_module",
    ...
    INVALID_LICENSE_FILE: "Invalid License File",
    ...
    STACK_OPERATION_IN_PROGRESS: "Stack operation is not finished yet",
    PROXY_IS_NOT_READY: "Proxy is not ready"
};
