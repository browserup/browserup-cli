...
export class Generator {
    ...
    static async generate(scenario_id, config) {
        ...
        const rendered_scenario_template = ejs.render(template, {
            open_local_ports: Constants.OPEN_LOCAL_PORTS,
            browserup_rails_local_mount_path: Constants.BROWSERUP_RAILS_LOCAL_MOUNT_PATH,
            browserup_rails_env: Constants.BROWSERUP_RAILS_ENV,
            chronograf: Constants.CHRONOGRAF,
            browserup_grid_api_debug: Constants.BROWSERUP_GRID_API_DEBUG,
            browserup_grid_api_debug_port: Constants.BROWSERUP_GRID_API_DEBUG_PORT,
            browserup_grid_api_debug_suspend: Constants.BROWSERUP_GRID_API_DEBUG_SUSPEND,
            browserup_minion_debug: Constants.BROWSERUP_MINION_DEBUG,
            browserup_minion_debug_port: Constants.BROWSERUP_MINION_DEBUG_PORT,
            browserup_minion_debug_suspend: Constants.BROWSERUP_MINION_DEBUG_SUSPEND,
            browserup_grid_coordinator_debug: Constants.BROWSERUP_GRID_COORDINATOR_DEBUG,
            browserup_grid_coordinator_debug_port: Constants.BROWSERUP_GRID_COORDINATOR_DEBUG_PORT,
            browserup_grid_coordinator_debug_suspend: Constants.BROWSERUP_GRID_COORDINATOR_DEBUG_SUSPEND
        });
