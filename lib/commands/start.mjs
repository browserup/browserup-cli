...
const MAX_DIR_SIZE_MB = 200;
const MAX_DIR_SIZE_BYTES = MAX_DIR_SIZE_MB * 1024 * 1024;
...
async function assessArtifactDirectoryValidity(artifact_dir)  {
    ...
    if (directorySize > MAX_DIR_SIZE_BYTES) {
        log.info(`WARNING. The current directory exceeds ${MAX_DIR_SIZE_MB}MB in size. Please ensure that you are using the correct directory.`);
        process.exit(1);
    }
