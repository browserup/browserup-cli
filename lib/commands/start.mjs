...
export async function start(options, program_opts) {
    ...
    } catch (e) { return logAndExit('Error loading config', e)   };
    ...
    const remote_run_id = await uploadAndRun(api_token, config).catch((e) => {  return logAndExit('Error uploading scenario', e)   }   );
...
async function uploadAndRun(api_token, config) {
