...
export class Config {
    constructor(configPath) {
        ...
        if(!fileExists(this.configPath)) {
            throw decoratedError({msg: `Config missing at ${this.configPath}`,  error: e, type: ErrorType.INVALID_CONFIG});
        ...
        try {
            ...
            if (e.code != undefined && (e.code == "ENOENT" ||e.code == "ENOENT" )) {
    ...
    assignDefaultClusterType() {
        ...
        this.model.browserup.clusterType = this.model.browserup.clusterType || DEFAULT_CLUSTER_TYPE;
    }
