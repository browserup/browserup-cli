...
export class WebConsoleClient {
    ...
    static async sendPostRequest({path, qParams = {}, data, extraHeaders = {}, payload, expectedCodes = [200, 201]}) {
    ...
    static async sendRequest({path, qParams = {}, payload, data, extraHeaders = {}, method, expectedCodes = [200, 201]}) {
        const headers = {
    ...
    static getWebconsoleURL(path) {
        return `${BrowserUpUrl.browserupLoadUrl()}/${path}`
    }
}
