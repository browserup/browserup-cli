...
import { dockerComposeYmlPath } from "../utils/browserup_paths.mjs";
...
export class LocalClusterPilot extends ClusterPilot {
    async createCluster({ clusterParams }) {
        ...
        if (!clusterParams.useLocalCache) {
            ...
            await DockerClient.dockerComposePull(composeYmlFile)
        }
    ...
    async upgradeCluster(credentials) {
        ...
        await localClusterPilotInstance.createCluster({ clusterParams: clusterParams });
    }
