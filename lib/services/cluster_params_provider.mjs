...
import {API_TOKEN_SIZE} from "../constants.mjs";
    ...
    static createClusterParams(cliOptions) {
        ...
        if (clusterType === ClusterType.AWS) {
            clusterParams = new RemoteClusterParams({
                ...
                keyPairName: cliOptions.key,
                minionsKeyPairName: cliOptions.minionsKeyPairName,
                createKeyPair: cliOptions.createKeyPair,
