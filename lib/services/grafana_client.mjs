...
export class GrafanaClient {
    ...
    async createGridServicesDashboard() {
        await this.createBrowserupDashboard("grafana-grid-services-dashboard.json")
    }

    async createDefaultDashboard() {
        await this.createBrowserupDashboard("grafana-default-dashboard.json", true)
    }

    async createBrowserupDashboard(awsResourceFileName, makeDefault = false) {
