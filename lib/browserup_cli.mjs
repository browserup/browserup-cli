...
import {postInstall } from "./commands/post-install.mjs";
...
export const SERVICES_VERSION = "release-1.0.8";
...
export class BrowserUpCli {
    ...
    constructor(exitOverride = false, outHsh = null) {
        ...
        cluster
            ...
            .description("Run post-install hooks")
            .action(async (args) => {
                await this.runCommand(postInstall, args, this.program.opts());
            });
        ...
        load
            ...
            .option("--selenium-csharp", "Init a sample dotnet script with C#")
