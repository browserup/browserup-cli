...
export class BrowserUpCli {
  ...
  ${chalk.blue("--name (-n)")}  Name of the report to run.
    ...
    Pass the value ${chalk.blue("config")} as the name to run the reports defined in the config file. 
    These reports are under the ${chalk.blue("reports:")} key in the config file.

    Use the value ${chalk.green("system")} to run these standard system-defined reports:
