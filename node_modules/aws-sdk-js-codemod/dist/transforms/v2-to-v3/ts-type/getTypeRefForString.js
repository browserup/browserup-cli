...
exports.getTypeRefForString = void 0;
const arrayRegex = /^Array<(.*)>$/;
const recordRegex = /^Record<string, (.*)>$/;
const getTypeRefForString = (j, v3ClientDefaultLocalName, v3ClientTypeString) => {
    ...
    if (arrayRegexMatches) {
        ...
        const typeArgument = (0, exports.getTypeRefForString)(j, v3ClientDefaultLocalName, type);
...
exports.getTypeRefForString = getTypeRefForString;
