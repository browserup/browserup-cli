...
exports.addClientImportEquals = void 0;
const apis_1 = require("../apis");
const ts_type_1 = require("../ts-type");
const addClientDefaultImportEquals_1 = require("./addClientDefaultImportEquals");
const addClientNamedImportEquals_1 = require("./addClientNamedImportEquals");
...
const addClientImportEquals = (j, source, options) => {
    ...
    if (v3ClientTypesCount > 0) {
        (0, addClientDefaultImportEquals_1.addClientDefaultImportEquals)(j, source, options);
    }
    if (newExpressionCount > 0 || clientTSTypeRefCount > 0) {
        (0, addClientNamedImportEquals_1.addClientNamedImportEquals)(j, source, {
            ...options,
...
exports.addClientImportEquals = addClientImportEquals;
